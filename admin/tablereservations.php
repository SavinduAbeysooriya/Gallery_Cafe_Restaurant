...
if(isset($_GET['delete'])){
   $id = $_GET['delete'];
   mysqli_query($conn, "DELETE FROM bookedtable WHERE id = $id");
...
<div class="admin-product-form-container">
   ...
   <?php
   $select = mysqli_query($conn, "SELECT * FROM bookedtable");
   ?>
      ...
      <table class="product-display-table">
        <h1><center>Table Reservations</center></h1>
         ...
         <tr>
            ...
            <td>
                <a href="tablereservations.php?delete=<?php echo $row['id']; ?>" class="btn"> 
