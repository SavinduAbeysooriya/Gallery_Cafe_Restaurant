...
if(isset($_POST['add_category'])){
   ...
   if(empty($category_name) ||  empty($category_image)){
      ...
      $insert = "INSERT INTO category(Name, Image) VALUES('$category_name', '$category_image')";
   ...
   <div class="product-display">
      <table class="product-display-table">
         ...
         <tr>
            ...
            <td>
               <a href="categoryadmin.php?delete=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>
